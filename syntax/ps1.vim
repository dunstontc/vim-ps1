...
" Regular Strings
" TODO: These aren't precisely correct and could use some work
syn region ps1String start=/"/ skip=/`"/ end=/"/ contains=@ps1StringSpecial,@Spell
syn region ps1String start=/'/ skip=/''/ end=/'/

" Here-Strings
syn region ps1HereString start=/@"$/ end=/^"@/ contains=@ps1StringSpecial,@Spell
syn region ps1HereString start=/@'$/ end=/^'@/
...
" vim:filetype=vim:foldmethod=marker:tabstop=4:shiftwidth=4:noexpandtab:
